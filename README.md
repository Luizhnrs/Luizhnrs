...
# Stack:
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=java,spring,angular,react,aws,lambda,sqs,ec2,eks,docker,kubernetes,kafka,postgres,chatgpt,claude&perline=15)
