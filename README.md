...
# Stack:
![My Skills](https://go-skill-icons.vercel.app/api/icons?i=java,spring,maven,aws,lambda,sqs,ec2,eks,docker,kubernetes,linux,kafka,postgres,chatgpt,claude&perline=15)
